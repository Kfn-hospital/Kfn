...
export const translations = {
  ...
  categoriesTitle: 'تصنيفات طلبات التنسيق والمتابعة',
  categoryName: 'اسم التصنيف',
  addCategory: 'إضافة تصنيف',
  categoryDeleteConfirm: 'تأكيد حذف التصنيف؟',
  categoryInUseError: 'تعذر الحذف — التصنيف ده مستخدم في طلبات موجودة',
  noCategories: 'لا يوجد تصنيفات بعد',
  filtersTitle: 'فلاتر البحث',
  filterSearchPlaceholder: 'بحث بعنوان الطلب...',
  filterDateFrom: 'من تاريخ',
  filterDateTo: 'إلى تاريخ',
  filterAllCategories: 'كل التصنيفات',
  filterAllStatuses: 'الكل',
  clearFilters: 'مسح الفلاتر',
  noFilteredResults: 'لا توجد طلبات مطابقة لهذا الفلتر',
  ...
  confirmDeleteRequest: 'متأكد إنك عايز تحذف هذا الطلب؟ الإجراء ده نهائي ومش هيظهر في الإحصائيات بعد كده.',
  ...
  activate: 'تفعيل',
    ...
    allBookingsTitle: 'كل الحجوزات',
    roomsListLabel: 'القاعات المتاحة',
...
myStatsSubtitle: 'نظرة على حجوزاتك وطلباتك الخاصة فقط',
canUploadFiles: 'يقدر يضيف ملفات',
canUploadFilesForced: 'صلاحية تلقائية حسب الدور الوظيفي',
lastEmailErrorLabel: 'آخر خطأ في إرسال إيميل',
exportCsv: 'تصدير CSV',
bookingsByMonth: 'الحجوزات شهريًا',
topRooms: 'أكثر القاعات استخدامًا',
requestsByCategory: 'الطلبات حسب الفئة',
requestStatusBreakdown: 'توزيع حالة الطلبات',
requestsSectionTitle: 'حالة طلبات التنسيق والمتابعة',
requestsByAssigneeTitle: 'توزيع الطلبات حسب الموظف المسند إليه',
requestsByAssigneeSubtitle: 'الطلب الواحد ممكن يكون له أكثر من موظف مسند، فالأرقام هنا بتوضح عبء العمل الفعلي لكل شخص.',
noAssigneeData: 'لا توجد طلبات مسندة بعد',
...
userCreated: 'تم إنشاء المستخدم بنجاح',
  ...
  categoriesTitle: 'Coordination Request Categories',
  categoryName: 'Category Name',
  addCategory: 'Add Category',
  categoryDeleteConfirm: 'Confirm deleting this category?',
  categoryInUseError: 'Could not delete — this category is used by existing requests',
  noCategories: 'No categories yet',
  filtersTitle: 'Filters',
  filterSearchPlaceholder: 'Search by request title...',
  filterDateFrom: 'From Date',
  filterDateTo: 'To Date',
  filterAllCategories: 'All Categories',
  filterAllStatuses: 'All',
  clearFilters: 'Clear Filters',
  noFilteredResults: 'No requests match this filter',
  ...
  confirmDeleteRequest: 'Are you sure you want to delete this request? This cannot be undone and it will no longer appear in statistics.',
  ...
  activate: 'Activate',
    ...
    roomsListLabel: 'Available Rooms',
...
myStatsSubtitle: 'An overview of your own bookings and requests only',
canUploadFiles: 'Can Add Files',
canUploadFilesForced: 'Automatic permission based on job role',
lastEmailErrorLabel: 'Last Email Send Error',
exportCsv: 'Export CSV',
bookingsByMonth: 'Bookings by Month',
topRooms: 'Most Used Rooms',
requestsByCategory: 'Requests by Category',
requestStatusBreakdown: 'Request Status Breakdown',
requestsSectionTitle: 'Coordination Requests Status',
requestsByAssigneeTitle: 'Requests by Assigned Employee',
requestsByAssigneeSubtitle: 'Each request may have more than one assignee, so counts reflect per-person workload.',
noAssigneeData: 'No assigned requests yet',
